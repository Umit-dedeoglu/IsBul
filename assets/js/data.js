...
const KATEGORİLER = [
  {
    ...
    subCategories: [
      ...
      { id: 'insaat-sonrasi', label: 'İnşaat Sonrası Temizlik', icon: '🧽', desc: 'Tadilat veya inşaat sonrası boya, harç ve toz kalıntılarının temizlenmesi.', price: '600' },
      { id: 'koltuk-yikama', label: 'Koltuk & Halı Yıkama', icon: '🫧', desc: 'Makineli yıkama ve buharlı temizleme ile koltuk, halı ve kilimler yenileniyor.', price: '350' },
  ...
  },
  {
    ...
    tags: ['Boya Badana', 'Fayans Seramik', 'Mutfak Banyo Tadilatı', 'Alçıpan & Kartonpiyer', 'Çatı Tamiri', 'Mantolama İzolasyon'],
    subCategories: [
      { id: 'boya-badana', label: 'Boya Badana', icon: '🖌️', desc: 'Oda, salon ve tüm iç mekan boya işleri. Alçı düzeltme ve badana dahil.', price: '400', hot: true },
      ...
      { id: 'mutfak-banyo', label: 'Mutfak & Banyo Tadilatı', icon: '🛠️', desc: 'Komple banyo veya mutfak yenileme, dolap, tesisat ve fayans işleri.', price: '2000' },
      { id: 'alcipan', label: 'Alçıpan & Asma Tavan', icon: '🪜', desc: 'Bölme duvar, asma tavan, led spot ve niş uygulamaları.', price: '800' },
      { id: 'izolasyon', label: 'Mantolama & İzolasyon', icon: '🧱', desc: 'Isı, ses ve su yalıtımı işlemleri. Dış cephe mantolama.', price: '1500' }
    ]
  },
  {
    cat: 'nakliyat',
    ...
    tags: ['Evden Eve Nakliyat', 'Şehirler Arası Nakliyat', 'Parça Eşya Taşıma', 'Sadece Nakliye Aracı', 'Depolama'],
    subCategories: [
      ...
      { id: 'sehirler-arasi', label: 'Şehirler Arası Nakliye', icon: '🚚', desc: 'Türkiye geneli güvenli ve sigortalı şehirler arası eşya taşıma.', price: '5000' },
...
const TÜM_UZMANLAR = [
  // İSTANBUL
  { id:'e1',  name:'Mehmet Arslan',    city:'İstanbul', avatar:'MA', color:'#6C63FF', title:'Mobilya Montaj Uzmanı',      categories:['montaj','tv'],      rating:4.97, reviews:312, price:280, experience:'8 yıl',  elite:true,  bio:'Tüm marka mobilya montajı. Aynı gün hizmet verebiliyorum.',          tags: ['Mobilya Montajı', 'TV Montajı'], reviewList:[{user:'c1',rating:5,text:'Harika iş çıkardı, çok hızlı.',date:'2024-11-12',service:'Mobilya Montaj'},{user:'c6',rating:5,text:'Profesyonel çalışma, teşekkürler.',date:'2024-10-28',service:'Mobilya Montajı'}]},
  { id:'e2',  name:'Ayşe Kaya',        city:'İstanbul', avatar:'AK', color:'#FF6B6B', title:'Ev Temizlik Uzmanı',          categories:['temizlik'],         rating:4.95, reviews:228, price:250, experience:'5 yıl',  elite:true,  bio:'Hijyen sertifikalı temizlik uzmanı.',                               tags: ['Ev Temizliği', 'Ofis Temizliği', 'Dış Cephe Cam Temizliği'], reviewList:[{user:'c2',rating:5,text:'Çok temiz ve dikkatli.',date:'2024-11-05',service:'Derin Temizlik'},{user:'c7',rating:5,text:'Haftalık geliyor, harika.',date:'2024-10-20',service:'Ev Temizliği'}]},
  { id:'e5',  name:'Ali Şahin',        city:'İstanbul', avatar:'AŞ', color:'#96CEB4', title:'Lisanslı Elektrikçi',         categories:['elektrik'],         rating:4.94, reviews:274, price:300, experience:'10 yıl', elite:true,  bio:'Lisanslı elektrik teknisyeni.',                                     tags: ['Priz ve Anahtar Montajı', 'Aydınlatma Montajı', 'Sigorta & Pano Arızaları'], reviewList:[{user:'c5',rating:5,text:'Aydınlatmayı tamamen yeniledi.',date:'2024-11-01',service:'Aydınlatma'}]},
  { id:'e9',  name:'Ercan Polat',      city:'İstanbul', avatar:'EP', color:'#06b6d4', title:'Elektrik & Güvenlik',         categories:['elektrik'],         rating:4.86, reviews:112, price:320, experience:'8 yıl',  elite:false, bio:'Kamera, alarm ve akıllı ev sistemleri.',                            tags: ['Güvenlik Sistemleri', 'Akıllı Ev Sistemleri'], reviewList:[{user:'c1',rating:5,text:'Kamerayı kurdu, çok memnunum.',date:'2024-10-22',service:'Güvenlik'}]},
  { id:'e13', name:'Selin Yılmaz',     city:'İstanbul', avatar:'SY', color:'#f43f5e', title:'Nakliyat Uzmanı',             categories:['nakliyat'],         rating:4.88, reviews:134, price:500, experience:'6 yıl',  elite:false, bio:'Ev ve ofis taşıma, tam sigortalı nakliyat.',                        tags: ['Evden Eve Nakliyat'], reviewList:[{user:'c3',rating:5,text:'Hiçbir hasar olmadı.',date:'2024-11-10',service:'Ev Taşıma'}]},
  { id:'e17', name:'Kemal Yıldız',     city:'İstanbul', avatar:'KY', color:'#8b5cf6', title:'Boyacı & Dekorasyon',         categories:['boya'],             rating:4.91, reviews:98,  price:360, experience:'7 yıl',  elite:false, bio:'İç cephe boya, dekoratif efektler, alçı.',                          tags: ['Boya Badana'], reviewList:[{user:'c4',rating:5,text:'Duvarlar mükemmel görünüyor.',date:'2024-10-25',service:'İç Boya'}]},

  // ANKARA
  { id:'e3',  name:'Can Hatipoğlu',   city:'Ankara',   avatar:'CH', color:'#4ECDC4', title:'Tesisatçı',                   categories:['tesisat'],          rating:4.92, reviews:189, price:320, experience:'12 yıl', elite:false, bio:'Su tesisatı, doğalgaz, kalorifer tamiri.',                          tags: ['Su Tesisatı', 'Tıkanıklık Açma'], reviewList:[{user:'c3',rating:5,text:'Aynı gün geldi, sorunu çözdü.',date:'2024-11-08',service:'Banyo Tesisatı'}]},
  { id:'e4',  name:'Fatma Demir',     city:'Ankara',   avatar:'FD', color:'#FFD93D', title:'Boyacı & Dekorasyon',         categories:['boya'],             rating:4.90, reviews:156, price:350, experience:'7 yıl',  elite:false, bio:'İç cephe, dekoratif boya ve duvar kağıdı.',                         tags: ['Boya Badana'], reviewList:[{user:'c4',rating:5,text:'Fatma Hanım çok titiz çalıştı.',date:'2024-10-25',service:'İç Cephe'}]},
  { id:'e8',  name:'Semra Avcı',      city:'Ankara',   avatar:'SA', color:'#8b5cf6', title:'Temizlik Uzmanı',             categories:['temizlik'],         rating:4.91, reviews:167, price:260, experience:'4 yıl',  elite:false, bio:'Derin temizlik, taşınma sonrası temizlik.',                         tags: ['Ev Temizliği', 'İnşaat Sonrası Temizlik'], reviewList:[{user:'c9',rating:5,text:'Çok titiz.',date:'2024-11-03',service:'Derin Temizlik'}]},
  { id:'e14', name:'Berk Çelik',      city:'Ankara',   avatar:'BÇ', color:'#10b981', title:'Mobilya Montaj Uzmanı',       categories:['montaj'],           rating:4.89, reviews:145, price:260, experience:'5 yıl',  elite:false, bio:'Tüm marka mobilya montajı, hızlı ve temiz.',                      tags: ['Mobilya Montajı'], reviewList:[{user:'c6',rating:5,text:'Çok hızlı ve temiz çalıştı.',date:'2024-11-07',service:'Montaj'}]},
  { id:'e18', name:'Deniz Arslan',    city:'Ankara',   avatar:'DA', color:'#f59e0b', title:'Bahçe Bakım Uzmanı',          categories:['bahce'],            rating:4.86, reviews:77,  price:210, experience:'4 yıl',  elite:false, bio:'Çim biçme, budama, peyzaj tasarımı.',                               tags: ['Bahçe Bakımı', 'Peyzaj'], reviewList:[{user:'c7',rating:5,text:'Bahçemiz güzel oldu.',date:'2024-10-30',service:'Bahçe Bakımı'}]},

  // İZMİR
  { id:'e6',  name:'Zeynep Yıldız',   city:'İzmir',    avatar:'ZY', color:'#56AB2F', title:'Bahçe & Peyzaj Uzmanı',       categories:['bahce'],            rating:4.88, reviews:97,  price:220, experience:'6 yıl',  elite:false, bio:'Peyzaj tasarımı ve bahçe bakımı.',                                  tags: ['Bahçe Bakımı', 'Peyzaj'], reviewList:[{user:'c7',rating:5,text:'Bahçemizi güzel düzenledi.',date:'2024-10-30',service:'Bahçe'}]},
  { id:'e7',  name:'Hüseyin Korkmaz', city:'İzmir',    avatar:'HK', color:'#f59e0b', title:'Nakliyat & Taşıma',           categories:['nakliyat'],         rating:4.89, reviews:143, price:450, experience:'9 yıl',  elite:false, bio:'Ev ve ofis taşıma, ambalajlama dahil.',                             tags: ['Evden Eve Nakliyat'], reviewList:[{user:'c8',rating:5,text:'Hiçbir hasar olmadı.',date:'2024-11-10',service:'Ev Taşıma'}]},
  { id:'e15', name:'Aslı Kaya',       city:'İzmir',    avatar:'AK', color:'#ec4899', title:'Ev Temizlik Uzmanı',          categories:['temizlik'],         rating:4.93, reviews:201, price:270, experience:'6 yıl',  elite:true,  bio:'Haftalık ve derin temizlik uzmanı.',                                tags: ['Ev Temizliği', 'Dış Cephe Cam Temizliği'], reviewList:[{user:'c5',rating:5,text:'Her zaman kusursuz.',date:'2024-11-01',service:'Haftalık Temizlik'}]},
  { id:'e19', name:'Serkan Doğan',    city:'İzmir',    avatar:'SD', color:'#6366f1', title:'Elektrikçi',                  categories:['elektrik'],         rating:4.87, reviews:108, price:290, experience:'7 yıl',  elite:false, bio:'Priz, aydınlatma, panel işleri.',                                   tags: ['Priz ve Anahtar Montajı', 'Aydınlatma Montajı', 'Sigorta & Pano Arızaları'], reviewList:[{user:'c10',rating:5,text:'Hızlı ve güvenilir.',date:'2024-10-10',service:'Elektrik'}]},

  // BURSA
  { id:'e10', name:'Mustafa Çetin',   city:'Bursa',    avatar:'MÇ', color:'#ef4444', title:'Genel Tadilat Ustası',        categories:['boya','montaj','diger'], rating:4.85, reviews:89, price:300, experience:'15 yıl', elite:false, bio:'15 yıllık tadilat, boya, montaj.',                               tags: ['Boya Badana', 'Fayans & Seramik', 'Alçıpan & Kartonpiyer'], reviewList:[{user:'c6',rating:5,text:'Banyoyu komple yeniledi.',date:'2024-11-07',service:'Banyo Tadilatı'}]},
  { id:'e16', name:'Elif Şahin',      city:'Bursa',    avatar:'EŞ', color:'#a78bfa', title:'Temizlik Uzmanı',             categories:['temizlik'],         rating:4.89, reviews:115, price:240, experience:'5 yıl',  elite:false, bio:'Düzenli ve derin temizlik hizmetleri.',                             tags: ['Ev Temizliği', 'Ofis Temizliği', 'Koltuk Yıkama'], reviewList:[{user:'c8',rating:5,text:'Çok düzenli.',date:'2024-10-15',service:'Ev Temizliği'}]},
  { id:'e20', name:'Taner Yılmaz',    city:'Bursa',    avatar:'TY', color:'#0ea5e9', title:'Tesisatçı',                   categories:['tesisat'],          rating:4.90, reviews:132, price:310, experience:'8 yıl',  elite:false, bio:'Su ve doğalgaz tesisatı, arıza tamiri.',                            tags: ['Su Tesisatı', 'Doğalgaz Tesisatı'], reviewList:[{user:'c3',rating:5,text:'Sorunu hızla çözdü.',date:'2024-09-20',service:'Su Tesisatı'}]},

  // ANTALYA
  { id:'e21', name:'Meral Kaya',      city:'Antalya',  avatar:'MK', color:'#f97316', title:'Ev Temizlik Uzmanı',          categories:['temizlik'],         rating:4.92, reviews:178, price:255, experience:'5 yıl',  elite:false, bio:'Tatil evi ve konut temizliği.',                                     tags: ['Ev Temizliği'], reviewList:[{user:'c5',rating:5,text:'Harika hizmet.',date:'2024-11-05',service:'Ev Temizliği'}]},
  { id:'e22', name:'Oğuzhan Yıldız',  city:'Antalya',  avatar:'OY', color:'#22c55e', title:'Bahçe Bakım Uzmanı',          categories:['bahce'],            rating:4.87, reviews:89,  price:200, experience:'4 yıl',  elite:false, bio:'Bahçe bakımı ve peyzaj.',                                           tags: ['Bahçe Bakımı', 'Peyzaj'], reviewList:[{user:'c4',rating:5,text:'Çok güzel çalışma.',date:'2024-10-12',service:'Bahçe'}]},
  { id:'e23', name:'Gül Arslan',      city:'Antalya',  avatar:'GA', color:'#e11d48', title:'Tesisatçı',                   categories:['tesisat'],          rating:4.88, reviews:95,  price:305, experience:'6 yıl',  elite:false, bio:'Su tesisatı ve banyo düzenleme.',                                   tags: ['Su Tesisatı', 'Banyo Tadilatı', 'Tıkanıklık Açma'], reviewList:[{user:'c9',rating:5,text:'Hızlı çözüm.',date:'2024-09-28',service:'Banyo'}]},

  // GAZİANTEP
  { id:'e24', name:'Kadir Öztürk',    city:'Gaziantep', avatar:'KÖ', color:'#7c3aed', title:'Mobilya Montaj Uzmanı',      categories:['montaj'],           rating:4.86, reviews:112, price:250, experience:'6 yıl',  elite:false, bio:'Hızlı ve kaliteli mobilya montajı.',                               tags: ['Mobilya Montajı'], reviewList:[{user:'c1',rating:5,text:'Çok hızlı.',date:'2024-11-08',service:'Montaj'}]},
  { id:'e25', name:'Leyla Kara',      city:'Gaziantep', avatar:'LK', color:'#0891b2', title:'Temizlik Uzmanı',            categories:['temizlik'],         rating:4.90, reviews:143, price:245, experience:'4 yıl',  elite:false, bio:'Ev ve ofis temizliği.',                                             tags: ['Ev Temizliği', 'Ofis Temizliği'], reviewList:[{user:'c7',rating:5,text:'Çok temiz.',date:'2024-10-22',service:'Ev Temizliği'}]},

  // KONYA
  { id:'e26', name:'İbrahim Şahin',   city:'Konya',    avatar:'İŞ', color:'#059669', title:'Elektrikçi',                  categories:['elektrik'],         rating:4.89, reviews:107, price:285, experience:'8 yıl',  elite:false, bio:'Tüm elektrik işleri.',                                              tags: ['Priz ve Anahtar Montajı', 'Sigorta & Pano Arızaları', 'Aydınlatma Montajı'], reviewList:[{user:'c2',rating:5,text:'Güvenilir.',date:'2024-11-01',service:'Elektrik'}]},
  { id:'e27', name:'Hatice Demir',    city:'Konya',    avatar:'HD', color:'#db2777', title:'Ev Temizlik Uzmanı',          categories:['temizlik'],         rating:4.91, reviews:121, price:240, experience:'5 yıl',  elite:false, bio:'Haftalık ev temizliği.',                                            tags: ['Ev Temizliği'], reviewList:[{user:'c6',rating:5,text:'Mükemmel.',date:'2024-10-18',service:'Temizlik'}]},

  // ADANA
  { id:'e28', name:'Tarık Yılmaz',    city:'Adana',    avatar:'TY', color:'#b45309', title:'Boyacı',                      categories:['boya'],             rating:4.87, reviews:98,  price:340, experience:'9 yıl',  elite:false, bio:'İç cephe boya ve dekorasyon.',                                      tags: ['Boya Badana'], reviewList:[{user:'c3',rating:5,text:'Oda çok güzel.',date:'2024-11-02',service:'Boya'}]},
  { id:'e29', name:'Canan Yıldız',    city:'Adana',    avatar:'CY', color:'#0d9488', title:'Temizlik Uzmanı',             categories:['temizlik'],         rating:4.88, reviews:134, price:248, experience:'4 yıl',  elite:false, bio:'Konut ve daire temizliği.',                                         tags: ['Ev Temizliği'], reviewList:[{user:'c8',rating:5,text:'Çok memnun kaldık.',date:'2024-10-30',service:'Temizlik'}]},

  // MERSİN
  { id:'e30', name:'Ufuk Arslan',     city:'Mersin',   avatar:'UA', color:'#2563eb', title:'Nakliyat Uzmanı',             categories:['nakliyat'],         rating:4.86, reviews:87,  price:420, experience:'7 yıl',  elite:false, bio:'Ev ve iş yeri taşıma.',                                             tags: ['Evden Eve Nakliyat'], reviewList:[{user:'c1',rating:5,text:'Sorunsuz taşındık.',date:'2024-11-05',service:'Ev Taşıma'}]},
];
...
function seedDemoUsers() {
  ...
  const db = {};
  const demoUsers = [
    { firstName: 'Ümit', lastName: 'Dedeoğlu', email: 'umityakupdedeoglu0@gmail.com', password: 'Umit311234', role: 'admin', isExpert: true, expertData: { tags: ['Mobilya Montajı', 'TV Montajı', 'Priz ve Anahtar Montajı'], categories: ['montaj', 'tv', 'elektrik'], city: 'İstanbul', price: 350, rating: 5.0, reviews: 0, experience: '5+ yıl', bio: 'Profesyonel mobilya montajı, TV montajı ve elektrik işleri uzmanı. İstanbul genelinde hizmet veriyorum.', verified: true, elite: true, hours: 'Pzt-Cum: 09:00-18:00' }},
    ...
    { firstName: 'Fatma', lastName: 'Demir', email: 'fatma.demir@example.com', password: 'demo123', role: 'expert', isExpert: true, expertData: { tags: ['Boya Badana'], categories: ['boya'], city: 'Ankara', price: 350, rating: 4.90, reviews: 156, experience: '7 yıl', bio: 'İç cephe, dekoratif boya ve duvar kağıdı.', verified: true, elite: false }},
    { firstName: 'Ahmet', lastName: 'Öztürk', email: 'ahmet.ozturk@example.com', password: 'demo123', role: 'customer' },
    { firstName: 'Zeynep', lastName: 'Şahin', email: 'zeynep.sahin@example.com', password: 'demo123', role: 'expert', isExpert: true, expertData: { tags: ['Ev Temizliği', 'Dış Cephe Cam Temizliği'], categories: ['temizlik'], city: 'İzmir', price: 270, rating: 4.93, reviews: 201, experience: '6 yıl', bio: 'Haftalık ve derin temizlik uzmanı.', verified: true, elite: true }},
    { firstName: 'Can', lastName: 'Arslan', email: 'can.arslan@example.com', password: 'demo123', role: 'customer' },
    { firstName: 'Elif', lastName: 'Polat', email: 'elif.polat@example.com', password: 'demo123', role: 'expert', isExpert: true, expertData: { tags: ['Su Tesisatı', 'Tıkanıklık Açma'], categories: ['tesisat'], city: 'Bursa', price: 320, rating: 4.92, reviews: 189, experience: '12 yıl', bio: 'Su tesisatı, doğalgaz, kalorifer tamiri.', verified: true, elite: false }},
